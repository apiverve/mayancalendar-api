...
```gradle
dependencies {
    implementation 'com.github.apiverve:mayancalendar-api:1.1.13'
}
```
...
```java
import com.apiverve.mayancalendar.MayanCalendarAPIClient;
import com.apiverve.mayancalendar.APIResponse;
import com.apiverve.mayancalendar.APIException;

// Initialize the client
MayanCalendarAPIClient client = new MayanCalendarAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("date", "2024-12-21");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/mayancalendar](https://docs.apiverve.com/ref/mayancalendar)
...
- **Documentation:** [https://docs.apiverve.com/ref/mayancalendar](https://docs.apiverve.com/ref/mayancalendar)
- **Issues:** [GitHub Issues](https://github.com/apiverve/mayancalendar-api/issues)
