# Mayan Calendar API - Examples

This folder contains example code for using the Mayan Calendar API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/mayancalendar',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/mayancalendar");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/mayancalendar](https://docs.apiverve.com/ref/mayancalendar)
