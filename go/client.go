// Package mayancalendar provides a Go client for the Mayan Calendar API.
//
// For more information, visit: https://apiverve.com/marketplace/mayancalendar?utm_source=go&utm_medium=readme
package mayancalendar
...
const (
	baseURL        = "https://api.apiverve.com/v1/mayancalendar"
	defaultTimeout = 30 * time.Second
)

// Client is the Mayan Calendar API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Mayan Calendar API client.
...
// Execute makes a request to the Mayan Calendar API with typed parameters.
//
