...
// Request contains the parameters for the Mayan Calendar API.
//
// Parameters:
...
// ResponseData contains the data returned by the Mayan Calendar API.
type ResponseData struct {
	Gregorian string `json:"gregorian"`
	LongCount LongCountData `json:"longCount"`
	Tzolkin TzolkinData `json:"tzolkin"`
	Haab HaabData `json:"haab"`
	CalendarRound string `json:"calendarRound"`
	DaysSinceEpoch int `json:"daysSinceEpoch"`
}

// LongCountData represents the longCount object.
type LongCountData struct {
	Formatted string `json:"formatted"`
	Baktun int `json:"baktun"`
	Katun int `json:"katun"`
	Tun int `json:"tun"`
	Winal int `json:"winal"`
	Kin int `json:"kin"`
}

// TzolkinData represents the tzolkin object.
type TzolkinData struct {
	Number int `json:"number"`
	DayName string `json:"dayName"`
	Formatted string `json:"formatted"`
}

// HaabData represents the haab object.
type HaabData struct {
	Day int `json:"day"`
