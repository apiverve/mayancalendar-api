...
namespace APIVerve.API.MayanCalendar
{
    ...
    /// <summary>
    /// Client for the MayanCalendar API
    /// </summary>
    public class MayanCalendarAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/mayancalendar";
        ...
        public MayanCalendarAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MayanCalendarAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MayanCalendarAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MayanCalendarQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MayanCalendarQueryOptions options)
        {
        ...
        public ResponseObj Execute(MayanCalendarQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MayanCalendarQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MayanCalendarQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MayanCalendarQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MayanCalendarQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MayanCalendarQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MayanCalendarQueryOptions options)
        {
