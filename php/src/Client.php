...
namespace APIVerve\Mayancalendar;
...
/**
 * Client for the Mayan Calendar API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/mayancalendar?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/mayancalendar';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MayancalendarClient] {$message}\n";
        }
    }
}
