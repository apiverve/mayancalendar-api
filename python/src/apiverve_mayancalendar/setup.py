...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/mayancalendar',
        'Source': 'https://github.com/apiverve/mayancalendar-api',
        'Bug Tracker': 'https://github.com/apiverve/mayancalendar-api/issues'
    },
    classifiers=[
